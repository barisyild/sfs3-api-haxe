...
import sfs3.client.util.ApiVersion;
import sfs3.client.entities.data.AtomicBool;
...
import sfs3.client.requests.HandshakeRequest;
...
import sfs3.client.entities.managers.SFSRoomManager;
import sfs3.client.entities.managers.SFSBuddyManager;
