 ...
 * <p/>
 *
 * @see		sfs3.client.core.SFSEvent#ROOM_CAPACITY_CHANGE
 * @see		sfs3.client.core.SFSEvent#ROOM_CAPACITY_CHANGE_ERROR
 * @see		sfs3.client.requests.RoomSettings#getPermissions()
 */
@:expose("SFS3.ChangeRoomCapacityRequest")
class ChangeRoomCapacityRequest extends BaseRequest 
{
	 ...
	 * @see		sfs3.client.entities.Room#getMaxUsers()
	 */
