 ...
 * </p>
 *
 * @see sfs3.client.SmartFox#connectUdp()
 * @see sfs3.client.SmartFox#isUdpConnected()
 * @see sfs3.client.core.SFSEvent#EXTENSION_RESPONSE
 */
...
class ExtensionRequest extends BaseRequest
{
	 ...
	 * @see sfs3.client.entities.data.SFSObject SFSObject
	 */
