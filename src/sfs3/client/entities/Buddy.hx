 ...
 * </p>
 *
 * @see sfs3.client.entities.SFSBuddy
 */
interface Buddy 
{
	/**
	 ...
	 *
	 * @see		sfs3.client.entities.managers.IBuddyManager#getBuddyStates()
	 */
	 ...
	 * 
	 * @see		sfs3.client.entities.variables.BuddyVariable#isOffline
	 */
