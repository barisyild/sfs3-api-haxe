 ...
 * @see sfs3.client.requests.mmo.MMORoomSettings
...
class MMORoom extends SFSRoom
{
	 ...
	 * 
	 * @see	sfs3.client.requests.mmo.MMORoomSettings#setDefaultAOI()
	 */
	 ...
	 * 
	 * @see	sfs3.client.requests.mmo.MMORoomSettings#setMapLimits()
	 */
