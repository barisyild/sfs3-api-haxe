 ...
 *
 * @see sfs3.client.entities.managers.SFSBuddyManager
 */
interface IBuddyManager
{
	 ...
	 *
	 * @see		sfs3.client.entities.Buddy#getName()
	 */
	 ...
	 *
	 * @see		sfs3.client.entities.Buddy#getId()
	 * @see		#getBuddyByName
	 ...
	 *
	 * @see		sfs3.client.entities.Buddy#getNickName()
	 * @see		#getBuddyById
	 * @see		#getBuddyByName
	 */
	 ...
	 *
	 * @see		sfs3.client.entities.Buddy#isOnline()
	 */
	 ...
	 *
	 * @see		sfs3.client.entities.Buddy#getState()
	 */
	 ...
	 *
	 * @see		sfs3.client.entities.Buddy#isOnline()
	 * @see		sfs3.client.entities.variables.ReservedBuddyVariables
